...
class GrailsGradlePluginSpec extends BeanContextSpec implements CommandOutputFixture {
    ...
    void "test build gradle file and gradle properties"() {
        ...
        then:
        gradleProps.contains("grailsGradlePluginVersion=6.2.5-SNAPSHOT")
        gradleProps.contains("grailsVersion=6.2.4-SNAPSHOT")
    }
    ...
    void "test dependencies are present for buildSrc"() {
        ...
        then:
        template.contains('implementation "org.grails:grails-gradle-plugin:6.2.5-SNAPSHOT"')
    }
    ...
    void "test buildSrc is present for buildscript dependencies"() {
        ...
        expect:
        buildGradle != null
        buildGradle.contains("classpath \"org.grails:grails-gradle-plugin:6.2.5-SNAPSHOT\"")
