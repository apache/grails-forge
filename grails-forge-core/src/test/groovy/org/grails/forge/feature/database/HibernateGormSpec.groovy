...
class HibernateGormSpec extends ApplicationContextSpec implements CommandOutputFixture{
    ...
    void "test match values of datasource config"() {
        ...
        config.environments.development.dataSource.url == 'jdbc:h2:mem:devDb;LOCK_TIMEOUT=10000;DB_CLOSE_ON_EXIT=FALSE;TCP_KEEPALIVE=TRUE'
        config.environments.test.dataSource.url == 'jdbc:h2:mem:testDb;LOCK_TIMEOUT=10000;DB_CLOSE_ON_EXIT=FALSE;TCP_KEEPALIVE=TRUE'
        config.environments.production.dataSource.url == 'jdbc:h2:./prodDb;LOCK_TIMEOUT=10000;DB_CLOSE_ON_EXIT=FALSE;TCP_KEEPALIVE=TRUE'
    }
}
